...
class DefaultHistoricalRatesServiceTest {
    ...
    void getHistoricalRates_whenSomeDatesAreInDbAndSomeMissing_returnsCombinedData() {
        // ARRANGE
    ...
    void getHistoricalRates_whenStartDateAfterEndDate_returnsError() {
        // ARRANGE
    ...
    void getHistoricalRates_whenRequestingFutureDates_returnsError() {
        // ARRANGE
    ...
    void getHistoricalRates_whenAllDatesAreInDb_returnsOnlyDatabaseData() {
        // ARRANGE
    ...
    void getHistoricalDataCount_whenCalledWithValidPair_returnCount() {
        // ARRANGE
        long count = 43L;
    ...
    void getHistoricalDataCount_whenNoDataExists_returnsZero() {
        // ARRANGE
    ...
    void isDataCompleteForPeriod_whenAllDatesExist_returnsTrue() {
        // ARRANGE
    ...
    void isDataCompleteForPeriod_whenSomeDatesAreMissing_returnsFalse() {
        // ARRANGE
        LocalDate jan16 = LocalDate.of(2024, 1, 16);
        LocalDate jan17 = LocalDate.of(2024, 1, 17);
    ...
    void getDataDateRange_whenDataExists_returnsDateRange() {
        // ARRANGE
    ...
    void getDataDateRange_whenNoDataExists_returnsEmptyArray() {
        // ARRANGE
        when(repository.findEarliestDate(fromCurrency, toCurrency))
    ...
    void getHistoricalRates_whenPeriodIncludesWeekend_excludesWeekendDates() {
        // ARRANGE
    ...
    void getHistoricalRates_whenNoDbDataAndProviderFails_propagatesError() {
        // ARRANGE
        when(repository.findByPeriod(fromCurrency, toCurrency, startDate, endDate))
    ...
    void getHistoricalRates_whenDbHasDataAndProviderFails_returnsDbDataOnly() {
        // ARRANGE
        HistoricalExchangeRate dbRate = HistoricalExchangeRate.of(
            fromCurrency, toCurrency, new BigDecimal("1.0850"), 
            LocalDate.of(2024, 1, 15), "Database"
    ...
    void getHistoricalRates_whenMultipleSources_returnsSortedByDate() {
        // ARRANGE
        HistoricalExchangeRate dbRate2 = HistoricalExchangeRate.of(
            fromCurrency, toCurrency, new BigDecimal("1.0860"), 
            LocalDate.of(2024, 1, 16), "Database"
    ...
    void getHistoricalRates_whenSingleDayPeriod_worksCorrectly() {
        // ARRANGE
    ...
    void getHistoricalRates_whenSomeRecordsFailToSave_continuesWithOtherData() {
        // ARRANGE
        HistoricalExchangeRate apiRate1 = HistoricalExchangeRate.of(
            fromCurrency, toCurrency, new BigDecimal("1.0860"), 
